...
<body class="hold-transition skin-green sidebar-mini">
    ...
    <?php include 'uploads/register_page_header.php'; ?>
            ...
            <section class="content-header">
                <div class="container">
                    <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
                        <h3 class="text-center margin-bottom-20">Register Company for Placement Training</h3>
                        <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
                            <div class="col-md-6 latest-job">
                                ...
                                <div class="form-group">
                                    <input class="form-control input-lg" type="text" name="company_name" placeholder="Company Name" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control input-lg" type="text" name="course_offered" placeholder="Course Offered" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control input-lg" type="number" name="budget" placeholder="Budget" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6 latest-job">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="brochure" class="form-control input-lg">
                                </div>
                            </div>
                        </form>
                    </div>
